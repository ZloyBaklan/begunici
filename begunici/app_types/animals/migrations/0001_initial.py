    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('father', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children_father_sheep', to='veterinary.tag', verbose_name='Отец')),
                ...
                ('mother', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children_mother_sheep', to='veterinary.tag', verbose_name='Мать')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_archived', models.BooleanField(default=False, verbose_name='В архиве')),
                ('animal_status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='veterinary.status', verbose_name='Статус')),
                ('father', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children_father_ram', to='veterinary.tag', verbose_name='Отец')),
                ('mother', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children_mother_ram', to='veterinary.tag', verbose_name='Мать')),
                ('place', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='veterinary.place', verbose_name='Место')),
                ('tag', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='veterinary.tag', verbose_name='Бирка')),
                ('veterinary_history', models.ManyToManyField(blank=True, to='veterinary.veterinary', verbose_name='История ветобработок')),
                ('weight_records', models.ManyToManyField(blank=True, to='veterinary.weightrecord', verbose_name='История взвешиваний')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('animal_status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='veterinary.status', verbose_name='Статус')),
                ('father', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='maker_children_father', to='veterinary.tag', verbose_name='Отец')),
                ('mother', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='maker_children_mother', to='veterinary.tag', verbose_name='Мать')),
                ('place', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='veterinary.place', verbose_name='Место')),
                ('tag', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='veterinary.tag', verbose_name='Бирка')),
                ('veterinary_history', models.ManyToManyField(blank=True, to='veterinary.veterinary', verbose_name='История ветобработок')),
                ('weight_records', models.ManyToManyField(blank=True, to='veterinary.weightrecord', verbose_name='История взвешиваний')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_archived', models.BooleanField(default=False, verbose_name='В архиве')),
                ('animal_status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='veterinary.status', verbose_name='Статус')),
                ('father', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children_father_ewe', to='veterinary.tag', verbose_name='Отец')),
                ('mother', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children_mother_ewe', to='veterinary.tag', verbose_name='Мать')),
                ('place', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='veterinary.place', verbose_name='Место')),
                ('tag', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='veterinary.tag', verbose_name='Бирка')),
                ('veterinary_history', models.ManyToManyField(blank=True, to='veterinary.veterinary', verbose_name='История ветобработок')),
                ('weight_records', models.ManyToManyField(blank=True, to='veterinary.weightrecord', verbose_name='История взвешиваний')),
