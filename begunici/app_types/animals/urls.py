...
urlpatterns = [
    path('maker/<str:tag_number>/info/', MakerDetailView.as_view(), name='maker-detail'),
    path('makers/<str:tag_number>/analytics/', MakerAnalyticsView.as_view(), name='maker-analytics'),
    path('main_archive/', TemplateView.as_view(template_name='archive.html'), name='main_archive'),
    path('', include(router.urls)),
    path('maker/<str:tag_number>/api/', MakerViewSet.as_view({'get': 'retrieve_api'}), name='maker-api'),
    path('maker/<str:tag_number>/update_parents/', MakerViewSet.as_view({'patch': 'update_parents'}), name='update-parents'),
    ...
    path('maker/<str:tag_number>/children/', MakerViewSet.as_view({'get': 'children'}), name='maker-children'),
    path('maker/<str:tag_number>/status_history/', MakerViewSet.as_view({'get': 'status_history'}), name='maker-status-history'),
    path('maker/<str:tag_number>/place_history/', MakerViewSet.as_view({'get': 'place_history'}), name='maker-place-history'),
