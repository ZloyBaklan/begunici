...
from .vet_views import (
    ...
    PlaceMovementViewSet,
    VeterinaryViewSet,
    TagViewSet,
    WeightRecordViewSet,
    VeterinaryManagementView,
...
urlpatterns = [
    ...
    path(
        "statuses/", VeterinaryStatusesView.as_view(), name="veterinary_statuses"
    ),  # Маршрут для страницы управления статусами
    path(
        "places/", VeterinaryPlacesView.as_view(), name="veterinary_places"
    ),  # Маршрут для страницы управления местами
    path(
        "cares/", VeterinaryCaresView.as_view(), name="veterinary_cares"
    ),  # Маршрут для страницы управления типами ухода
]
