"""
Django settings for begunici project.
...
SECRET_KEY = "django-insecure-yt8beqip0qjts_3*66)!@16wav5*e#zo=$7yv+hk@__6)5473_"
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "begunici" / "templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "begunici.wsgi.application"
...
)  # Каталог для сбора статических файлов
...
REST_FRAMEWORK = {
    "DEFAULT_PERMISSION_CLASSES": [
        "rest_framework.permissions.AllowAny",  # Разрешаем неаутентифицированные запросы
    ],
