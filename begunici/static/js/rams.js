...
function getRamFiltersFromInputs() {
    return {
        ...
        date_otbivka_from: document.getElementById('ram-date-otbivka-from-filter')?.value || '',
        date_otbivka_to: document.getElementById('ram-date-otbivka-to-filter')?.value || '',
        age_min: document.getElementById('ram-age-min-filter')?.value || '',
        age_max: document.getElementById('ram-age-max-filter')?.value || '',
        weight_min: document.getElementById('ram-weight-min-filter')?.value || '',
        weight_max: document.getElementById('ram-weight-max-filter')?.value || '',
...
function initializeRamFiltersFromUrl() {
    addRshnPresenceFilter('ram-advanced-filters', 'ram-has-rshn-tag-filter');
    ...
    const dateOtbivkaFromInput = document.getElementById('ram-date-otbivka-from-filter');
    if (dateOtbivkaFromInput) dateOtbivkaFromInput.value = filters.date_otbivka_from;
    const dateOtbivkaToInput = document.getElementById('ram-date-otbivka-to-filter');
    ...
    const weightMinInput = document.getElementById('ram-weight-min-filter');
    if (weightMinInput) weightMinInput.value = filters.weight_min;
    const weightMaxInput = document.getElementById('ram-weight-max-filter');
...
async function applyArchiveStatus() {
    const selected = Array.from(selectedRams)
        .filter(tag => tag && String(tag).trim())
        .map(tag => ({ animalType: 'ram', tagNumber: String(tag).trim() }));
